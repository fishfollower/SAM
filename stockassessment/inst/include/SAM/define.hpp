...
SOURCE(
    template<class Type>
      ...
      fleetTypes = asVector<int>(getListElement(x,"fleetTypes",  &isNumericScalar));
      sampleTimes = asVector<Type>(getListElement(x,"sampleTimes",  &isNumericScalar));
      noYears = Rf_asInteger(getListElement(x,"noYears", &isNumericScalar));
      years = asVector<Type>(getListElement(x,"years",  &isNumericScalar));
      minAgePerFleet = asVector<int>(getListElement(x,"minAgePerFleet",  &isNumericScalar));
      maxAgePerFleet = asVector<int>(getListElement(x,"maxAgePerFleet",  &isNumericScalar));
      ...
      minWeek = asVector<int>(getListElement(x,"minWeek",  &isNumericScalar));
      maxWeek = asVector<int>(getListElement(x,"maxWeek",  &isNumericScalar));
      aux = asArray<int>(getListElement(x,"aux", &Rf_isArray));
      logobs = asVector<Type>(getListElement(x,"logobs",  &isNumericScalar));
      weight = asVector<Type>(getListElement(x,"weight",  &isNumericScalar));
