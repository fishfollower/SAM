...
//   MDSR_50(Type la, Type lb, Type lc, Type ld) : loga(la), logb(lb), logc(lc), logd(ld) {};
  
//   //Type fn (Type logs) override{
//   Type operator()(vector<Type> logs0){
//     Type logs = logs0(0);
...
//     Type v1 = logspace_add(Type(0.0), v0);
//     Type v2 = logspace_add(Type(0.0), -exp(-logc));
//     Type xx1 = logb + logd + logc + v1 + log(v1);
//     Type xx2 = logd + logspace_add(logb + logc + log(v2), logs) + v0;
...
//   MDSR_50<TMBad::ad_aug> f1(loga, logb, logc, logd);
//   MDSR_50<Type> f2(loga, logb, logc, logd);
//   //Type sv = f.minimize(logd);
//   vector<Type> x0(1); x0(0) = logd;
//   vector<Type> sv = newton::Newton(f1,x0);
//   return exp(-f2(sv));
// }
...
//   MDSR_51(Type la, Type lb, Type ld) : loga(la), logb(lb), logd(ld) {};
...
//   MDSR_51<TMBad::ad_aug> f1(loga, logb, logd);
//   MDSR_51<Type> f2(loga, logb, logd);
//   //Type sv = f.minimize(logd);
//   vector<Type> x0(1); x0(0) = logd;
//   vector<Type> sv = newton::Newton(f1,x0);
//   return exp(-f2(sv));
...
//   MDSR_52(Type la, Type lb, Type ld) : loga(la), logb(lb), logd(ld) {};
...
//   MDSR_52<TMBad::ad_aug> f1(loga, logb, logd);
//   MDSR_52<Type> f2(loga, logb, logd);
//    // Type sv = f.minimize(logd);
//   // return exp(-f.fn(sv));
//   vector<Type> x0(1); x0(0) = logd;
//   vector<Type> sv = newton::Newton(f1,x0);  
...
//   MDSR_53(Type la, Type lb, Type ld) : loga(la), logb(lb), logd(ld) {};
...
//   MDSR_67(Type la, Type lb, Type ld) : loga(la), logb(lb), logd(ld) {};
...
//   MDSR_67<TMBad::ad_aug> f1(loga, logb, logd);
//   MDSR_67<Type> f2(loga, logb, logd);
//     // Type sv = f.minimize(logd);
//   // return exp(-f.fn(sv));
//   vector<Type> x0(1); x0(0) = logd;
//   vector<Type> sv = newton::Newton(f1,x0);
