...
##' Compute and plot residual diagnostic tests for a SAM model fit
...
##' @param plot plot pvalues (default: TRUE)
##' @return list of matrices with p-values corresponding to the plots
##' @import plot.matrix
##' @details Student's t-test for bias, Chi-square test for variance 1, Ljung-Box test on lag 1 for auto-correlation in time and age directions, F for equal variances for obs < or > median, and Shapiro-Wilk test for normality.
##' @export
