...
##' \item{$stockRecruitmentModelCode:}{A single integer to specify the stock recruitment connection to use (0 for plain random walk on log recruitment, 1 for Ricker, 2 for Beverton-Holt, 3 for piece-wise constant, 61 for segmented regression/hockey stick, 62 for AR(1) on log-recruitment, 63 for bent hyperbola / smooth hockey stick, 64 for power function with degree < 1, 65 for power function with degree > 1, 66 for Shepher, 67 for Deriso, 68 for Saila-Lorda, 69 for sigmoidal Beverton-Holt, 90 for CMP spline, 91 for more flexible spline, and 92 for most flexible spline). See Albertsen & Trijoulet (2020) for details.}
...
##' @references
##' Albertsen, C. M. and Trijoulet, V. (2020) Model-based estimates of reference points in an age-based state-space stock assessment model. Fisheries Research, 230, 105618. doi: \doi{10.1016/j.fishres.2020.105618}
